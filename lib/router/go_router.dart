...
import 'package:tutam_fit/screens/admin/add_category_screen.dart';
import 'package:tutam_fit/screens/admin/add_product_screen.dart';
...
final goRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/main', builder: (_, _) => MainScreen(index: 0)),
      GoRoute(path: '/cart', builder: (_, _) => MainScreen(index: 3)),
